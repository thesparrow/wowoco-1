...
namespace ecard.Pages
{
    public class PreviewModel : PageModel
    {
        ...
        public void OnGet(string ID)
        {
            ...
            {
                //Decrypt Step 1 
                var utf8_ID = Convert.FromBase64String(ID);

                //Decrypt Step 2
                var decrypted_ID = Encoding.UTF8.GetString(utf8_ID);

                //Decrypt Step 3
                var read_ID = Int32.Parse(decrypted_ID);

                ////find the ID in the database 
                _myGreetings = _myDbBridge.Greetings.Find(read_ID);
